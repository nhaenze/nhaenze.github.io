...
For example, in an article published in the <i> Journal of Peace Research</i>, I show how the dynamics of ongoing armed conflict exacerbates the humanitarian consequences of natural hazards. By analyzing tropical cyclones in the Philippines, I demonstrate that periods of intense conflict significantly increase cyclone-related fatalities. This research highlights how political instability and violence can undermine disaster response capacity, leaving populations more exposed to environmental risks.
...
Another project explores how exactly natural disasters act as "critical junctures" that reshape governance institutions. Historically, external pressures and crises like war have often prompted state expansion and institutional reforms. My research examines how societies that experience repeated exposure to natural hazards adapt their political structures over time, whether through increased state capacity, new taxation mechanisms, or shifts in governance norms. I argue that natural hazards can be a signal of environmental threats that can make citizens more accepting of state authority. By analyzing historical data on earthquakes and fiscal institutions, I show that significant earthquakes have led to an expansion of state authority and capacity.
...
In collaboration with Viktoria Jansesberger, I analyze subnational adaptation aid distribution in the Philippines. Using a novel geo-coded dataset of climate adaptation projects, we investigate whether hazard exposure, vulnerability, or recent disaster impacts drive aid allocation. Our findings suggest that immediate humanitarian crises - rather than structural risk components - are the primary drivers of adaptation aid, raising concerns about the effectiveness of current funding mechanisms in building long-term resilience.

 <b>Papers</b> 

<a href="https://www.peio.me/wp-content/uploads/PEIO17/submission_86.pdf" target="_blank">Who needs it the most: Climate risks as catalysts for climate adaptation aid allocation? <i> Working Paper</i> (With Viktoria Jansesberger). </a><br>
